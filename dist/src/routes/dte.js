...
import { getAllEmpresas, getEmpresaByRut, createEmpresa, getPeriodosByEmpresa, createPeriodo, getResumenCompras, createResumenCompras, getDetalleCompras, createDetalleCompras, getAllProveedores, createProveedor, getAllTiposDte } from '../controllers/Dte.controller.js';
const router = Router();
// Empresa routes
