  ...
  try {
    ...
    for (const detalle of compras.detalleCompras) {
      ...
      const detalleData = {
        ...
        montoExento: detalle.montoExento?.toString() || '0',
        montoNeto: detalle.montoNeto?.toString() || '0',
        montoIvaRecuperable: detalle.montoIvaRecuperable?.toString() || '0',
        montoIvaNoRecuperable: detalle.montoIvaNoRecuperable?.toString() || '0',
        codigoIvaNoRecuperable: detalle.codigoIvaNoRecuperable,
        montoTotal: detalle.montoTotal?.toString() || '0',
        montoNetoActivoFijo: detalle.montoNetoActivoFijo?.toString() || '0',
        ivaActivoFijo: detalle.ivaActivoFijo?.toString() || '0',
        ivaUsoComun: detalle.ivaUsoComun?.toString() || '0',
        impuestoSinDerechoCredito: detalle.impuestoSinDerechoCredito?.toString() || '0',
        ivaNoRetenido: detalle.ivaNoRetenido?.toString() || '0',
        ...
        nceNdeFacturaCompra: detalle.nceNdeFacturaCompra?.toString() || '0',
